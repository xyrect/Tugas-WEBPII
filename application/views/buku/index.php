...
<div class="container-fluid">
    <?= $this->session->flashdata('success_message') ? '<div class="alert alert-success">' . $this->session->flashdata('success_message') . '</div>' : ''; ?>
    <?= $this->session->flashdata('error_message') ? '<div class="alert alert-danger">' . $this->session->flashdata('error_message') . '</div>' : ''; ?>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $b['dibooking']; ?></td>
                        <td>
                            <?php if (!empty($b['image']) && file_exists('assets/img/upload/' . $b['image'])): ?>
                                <picture>
