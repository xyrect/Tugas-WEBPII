                    ...
                    <?php $a = 1; foreach ($kategori as $k): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('buku/delete/') . $k['id_kategori']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['nama_kategori']; ?> ?');" class="badge badge-danger">
            ...
            <form action="<?= base_url('buku/kategori'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" name="nama_kategori" id="" class="form-control form-control-user" placeholder="Nama Kategori">
                    </div>
                </div>
