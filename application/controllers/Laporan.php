...
class Laporan extends CI_Controller
{
	...
	public function laporan_pinjam_pdf()
	{
		...
		// Load view dan simpan ke dalam variabel $html
		...
		// Load HTML ke Dompdf
		$this->dompdf_gen->set_paper($paper, $orientation);
		$this->dompdf_gen->load_html($html);
		
		// Render PDF
		$this->dompdf_gen->render();
		
		// Tampilkan PDF dalam bentuk stream ke browser
		$this->dompdf_gen->stream("laporan_data_peminjaman.pdf");
	}
